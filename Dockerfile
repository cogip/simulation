...
#bsdextrautils groff-base libice6 libpipeline1 libsm6 libuchardet0 libxaw7 libxcb-damage0 libxcursor1 libxft2 libxmu6 libxt6 man-db xbitmaps
...
ADD submodules/mcu-firmware/requirements.txt requirements-dev.txt /tmp/
