...
class PB_PathPose(_message.Message):
    __slots__ = ["allow_reverse", "bypass_anti_blocking", "max_speed_ratio_angular", "max_speed_ratio_linear", "pose", "timeout_ms"]
    ...
    timeout_ms: int
    def __init__(self, pose: _Optional[_Union[_PB_Pose_pb2.PB_Pose, _Mapping]] = ..., max_speed_ratio_linear: _Optional[int] = ..., max_speed_ratio_angular: _Optional[int] = ..., allow_reverse: bool = ..., bypass_anti_blocking: bool = ..., timeout_ms: _Optional[int] = ...) -> None: ...
