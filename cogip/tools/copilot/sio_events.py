...
class SioEvents(socketio.AsyncClientNamespace):
    ...
    async def on_command(self, data):
        ...
        match cmd:
            case "actuators_control":
                ...
                await self._copilot.pbcom.send_can_message(copilot.actuators_thread_start_uuid, None)
            case "angular_speed_pid_config":
                # Request angular speed pid state
                pid_id.id = PB_PidEnum.ANGULAR_SPEED_PID
                await self._copilot.pbcom.send_can_message(copilot.pid_request_uuid, pid_id)
    ...
    async def on_shell_command(self, data):
        ...
        * second part is arguments, if any, and goes to `desc` attribute.
        ...
        await self._copilot.pbcom.send_can_message(copilot.command_uuid, response)
    ...
    async def on_pose_start(self, data: dict[str, Any]):
        ...
        await self._copilot.pbcom.send_can_message(copilot.pose_start_uuid, pb_start_pose)
    ...
    async def on_pose_order(self, data: dict[str, Any]):
        ...
        await self._copilot.pbcom.send_can_message(copilot.pose_order_uuid, pb_pose_order)
    ...
    async def on_actuators_stop(self):
        ...
        Forward to mcu-firmware.
        """
        await self._copilot.pbcom.send_can_message(copilot.actuators_thread_stop_uuid, None)
    ...
    async def on_actuator_command(self, data: dict[str, Any]):
        ...
        await self._copilot.pbcom.send_can_message(copilot.actuators_command_uuid, pb_command)
    ...
    async def on_config_updated(self, config: dict[str, Any]) -> None:
        ...
        if pid_id and name:
            ...
            await self._copilot.pbcom.send_can_message(copilot.pid_uuid, self._copilot._pb_pids)
    ...
    async def on_set_controller(self, controller: int):
        ...
        await self._copilot.pbcom.send_can_message(copilot.controller_uuid, pb_controller)
    ...
    async def on_game_start(self):
        ...
        Forward to firmware.
        """
        await self._copilot.pbcom.send_can_message(copilot.game_start_uuid, None)
    ...
    async def on_game_end(self):
        ...
        Forward to firmware.
        """
        await self._copilot.pbcom.send_can_message(copilot.game_end_uuid, None)
    ...
    async def on_game_reset(self):
        ...
        Forward to firmware.
        """
        await self._copilot.pbcom.send_can_message(copilot.game_reset_uuid, None)
    ...
    async def on_brake(self):
        ...
        Forward to firmware.
        """
        await self._copilot.pbcom.send_can_message(copilot.brake_uuid, None)
