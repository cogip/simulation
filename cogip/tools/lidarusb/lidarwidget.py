...
class LidarWidget(QtWidgets.QWidget):
    """
    This class is a widget that provides the graphic view and instantiate the polar chart, sliders and the table view.
    ...
    Attributes:
        ...
        max_intensity: min value of the intensity range (use on the chart)
