...
class Action:
    ...
    def __init__(
        ...
        self.before_action_func: Callable[[socketio.ClientNamespace], None] = lambda planner: None
        self.after_action_func: Callable[[socketio.ClientNamespace], None] = lambda planner: None
