...
class Planner:
    ...
    async def update_actuator_state(self, actuator_state: ActuatorState):
        if actuator_state.id in self.game_context.emulated_actuator_states:
            return
        actuators_states = getattr(self.game_context, f"{actuator_state.kind}_states")
        ...
        if not self.virtual and actuator_state.id in self.game_context.emulated_actuator_states:
            del self.game_context.emulated_actuator_states[actuator_state.id]
