...
class ObstacleProperties(QtWidgets.QDialog):
    ...
    def __init__(self, parent: QtWidgets.QWidget, obstacle_entity: ObstacleEntity):
        ...
        self.spin_width.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        ...
        self.spin_length.setMaximum(1000)
        self.spin_length.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        ...
        self.spin_height.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
