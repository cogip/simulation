...
make -C ../mcu-firmware/applications/cup2023 BOARD=cogip-native all -j
mate-terminal --command="make -C ../mcu-firmware/applications/cup2023 BOARD=cogip-native term" &

cogip-copilot -c vcan0 -b 500000 -B 1000000
cogip-server &
cogip-planner &
